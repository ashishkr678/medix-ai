...
def helper(dis):
    ...
    pre = [col for col in precautions[precautions['Disease'] == dis][['Precaution_1', 'Precaution_2', 'Precaution_3', 'Precaution_4']].values[0]]
...
def get_predicted_value(patient_symptoms):
    ...
    predicted_disease_code = svc.predict([input_vector])[0]
    return diseases_list.get(predicted_disease_code, "Unknown Disease")
